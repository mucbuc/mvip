namespace om636
{
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////
    template<class T>
    const typename persistant_raw<T>::storage_type & persistant_raw<T>::storage() const
    {   return m_storage; }
        
    /////////////////////////////////////////////////////////////////////////////////////////////
    template<class T> 
    typename persistant_raw<T>::storage_type & persistant_raw<T>::storage()
    {   return m_storage; }
    
    /////////////////////////////////////////////////////////////////////////////////////////////
    template<class T>
    void persistant_raw<T>::read( const char * path )
    {
        using namespace std;
        ...
        while (getline(in, key) && getline(in, value))
        {
            ...
            {
                using private_persistant::count_bits;
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////
    template<class T> 
    void persistant_raw<T>::write( const char * path )
    {
        using namespace std;
        ofstream out( path, ios_base::out | ios_base::trunc );
        
        if (out)
            for_each( m_storage.begin(), m_storage.end(), private_persistant::out_op<ofstream>(out) );
        else
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////
    template<class T>
    persistant_raw<T>::persistant_raw()
    {}
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////
    template<class T>
    void persistant<T>::open( const char * c_path )
    {
