#ifndef UNIT_TEST_H__aKFXIJVg19rRDhPm7e3stf4Y5MzCOW
#define UNIT_TEST_H__aKFXIJVg19rRDhPm7e3stf4Y5MzCOW
...
namespace om636
{
    namespace tools 
    {
        ...
        {
            template<class U>
            static void test_binary( const T & a, const T & b, const T & result, U f )
            {
                ASSERT( (a.*f)(b) == result );
                ASSERT( !((a.*f)(b) != result) );
            }
...
#endif // __UNIT_TEST_H__aKFXIJVg19rRDhPm7e3stf4Y5MzCOW